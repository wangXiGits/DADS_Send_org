/**
 * add by rencm on 2013-12-3下午04:50:31
 */
 ...
 * 类描述：暂无 
 * 创建人：rcm   
 * 创建时间：2013-12-3 下午04:50:31   
 * 修改人：rcm   
 * 修改时间：2013-12-3 下午04:50:31   
 * 修改备注： 
 * @version   
 */
public class Test1To5minutes {
	@Test
	public void test(){
...
//		dvArr.set(0,oneToFive("snp5",dvArr.getJSONObject(0)));
	 ...
	 * JSONObject
	 */
	public JSONObject oneToFive(String key, JSONObject jo){
	 ...
	 * JSONObject
	 */
	public JSONObject toEffective(String key, JSONObject jo){
	 ...
	 * JSONArray
	 */
	private JSONArray CalculateEffectiveStep(JSONArray jsonData)
	{
		int tenmin_ef = 0;
